...
Функция ПодтипВложенияПоТипуСообщения(ТипСообщения) Экспорт
	...
	//Соответствие.Вставить(1000,	"SEDI_APPEAL_RESP"); // Сообщения 1000,1001,1002 обрабатываем только с 25.4100
...
Функция ИмяФормыПоТипуСообщения(ТипСообщения) Экспорт
	...
	//Соответствие.Вставить(1000,	"Ответ страхователя на обращение"); // Сообщения 1000,1001,1002 обрабатываем только с 25.4100
...
Функция МассивОбрабатываемыхПодтиповВложений() Экспорт
	...
	// Сообщения 1000,1001,1002 обрабатываем только с 25.4100
