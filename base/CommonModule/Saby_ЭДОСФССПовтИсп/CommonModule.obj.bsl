...
Функция ПодтипВложенияПоТипуСообщения(ТипСообщения) Экспорт
	...
	//Соответствие.Вставить(120,	"SEDI_DISABILITY_REQUEST"); // ПОКА НЕ ВЫПУСКАЕМ
...
Функция ИмяФормыПоТипуСообщения(ТипСообщения) Экспорт
	...
	//Соответствие.Вставить(120,	"Возмещение расходов на оплату дополнительных выходных"); // ПОКА НЕ ВЫПУСКАЕМ
