...
Процедура ПослеОбработки1СSEDI_UUID(Результат, Контекст) Экспорт
	...
	Sedo_ЭДОСФСС.ОбновитьОтправкуФССпоSEDI_UUID(Результат.ИдентификаторЗапроса, Контекст.Документ);
