...
Функция ПолучитьСтруктуруОтправляемогоКомплекта(ПараметрыСообщения)
	...
	СтруктураОрг = МодульЭДОСФССПовтИсп().Saby_НашаОрганизация(ПараметрыСообщения.Организация, Ложь);
	...
	Иначе
		...
		СтруктураГоловнаяОрг = МодульЭДОСФССПовтИсп().Saby_НашаОрганизация(
